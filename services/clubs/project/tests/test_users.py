...
class TestUserService(BaseTestCase):
    ...
    def test_single_user(self):
        ...
        user = add_user(username="michael", email="michael@gmail.com")
        with self.client:
    ...
    def test_all_users(self):
        """Ensure get single user behaves correctly."""
        add_user(username="michael", email="michael@gmail.com")
        add_user(username="bob", email="bob@gmail.com")
        with self.client:
            response = self.client.get(f'/users')
            data = json.loads(response.data.decode())
            self.assertEqual(response.status_code, 200)
            self.assertIn('michael', data['data']['users'][0]['username'])
            self.assertIn('michael@gmail.com', data['data']['users'][0]['email'])
